...
from modules.minecraft.status.address import Address
from modules.minecraft.status.protocol.connection import Connection, TCPAsyncSocketConnection, TCPSocketConnection
from modules.minecraft.status.status_response import JavaStatusResponse
...
class AsyncServerPinger(ServerPinger):
    def __init__(
        ...
        super().__init__(connection, address=address, version=version, ping_token=ping_token)
